sap.ui.define([
	...
	return Controller.extend("PortalPortal.controller.Maintanence", {

		onInit: function() {
			window.console.log("Maintanence Loginpage initialized");
		},
		...
		onLogin: function() {
			this._getDialog("PortalPortal.view.Fragments.BusyDialog").open();
			...
			if (uid !== "" || pwd !== "") {
				...
				if (status === 'TRUE') {
					...
					jQuery.sap.intervalCall(2000, this._getDialog("PortalPortal.view.Fragments.BusyDialog").close(), this);
					MessageToast.show("Login Successful !");

					oRouter.navTo("MaintenanceDashboard");
