sap.ui.define([
	...
	return Controller.extend("PortalPortal.controller.Shopfloor", {
		onInit: function() {
			window.console.log("Shopfloor Login page initialized");
		},
		
		gotoNext : function(){
			var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
			oRouter.navTo("ShopfloorDashboard");
		},
		...
		onBack: function() {
			...
			if (sPreviousHash !== undefined) {
				...
				this.getOwnerComponent().getRouter().navTo("Index");
			}
		},
		...
		onLogin: function() {
			this._getDialog("PortalPortal.view.Fragments.BusyDialogsf").open();
			...
			if (uid !== "" || pwd !== "") {
				...
				if (status === 'TRUE') {
					...
					var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
					jQuery.sap.intervalCall(2000, this._getDialog("PortalPortal.view.Fragments.BusyDialogsf").close(), this);
