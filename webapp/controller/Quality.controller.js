sap.ui.define([
	...
	return Controller.extend("PortalPortal.controller.Quality", {
		onInit: function() {
			window.console.log("Quality Login page initialized");
		},
		...
		onLogin: function() {
			this._getDialog("PortalPortal.view.Fragments.BusyDialogquality").open();
			...
			if (uid !== "" || pwd !== "") {
				...
				if (status === 'TRUE') {
					...
					var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
					jQuery.sap.intervalCall(2000, this._getDialog("PortalPortal.view.Fragments.BusyDialogquality").close(), this);
