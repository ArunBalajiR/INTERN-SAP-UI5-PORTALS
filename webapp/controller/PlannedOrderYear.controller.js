sap.ui.define([
	...
	return Controller.extend("PortalPortal.controller.PlannedOrderYear", {
		...
		onFilterPlnYear: function(oEvent) {
			...
			// filter binding
			var oList = this.getView().byId("plannedOrderFilterYrTable");
			var oBinding = oList.getBinding("items");
			oBinding.filter(aFilter);

		},
		
		onPlannedFilterYrSelect : function(){
			this._getplanOrderDialog().open();
			
			var oModelData = this.getView().byId("plannedOrderFilterYrTable").getModel("plannedOrderFilterYr");
		
			var r = this.getView().byId("plannedOrderFilterYrTable")._aSelectedPaths[0].split("/")[2];
		...
		setFilteredData : function(){
			...
			this.getView().setModel(jsonModelplyr, "plannedOrderFilterYr");
